...
public class Spielanleitung extends JDialog {
	...
	private static final long serialVersionUID = -8979206745322564225L;
	...
	Spielanleitung(){
		...
		gbcPositionSize(0, 1, 2, 1);
		gbc.insets = new Insets(20,5,5,5);
		text = new JLabel ();
		text.setOpaque(false);
		text.setBounds(350, 40, 300, 500);
		...
		text.setText("<html><body><p style=\\\"width:300px\\\">"
				...
				+ "  Gang im Labyrinth erreichen kannst. Das gilt nicht, wenn dort "
				+ "  bereits eine andere Spielfigur steht. Du darfst soweit ziehen, "
	...
	private void gbcPositionSize(int x, int y, int width, int height) {
		this.gbc.gridx = x;
		this.gbc.gridy = y;
